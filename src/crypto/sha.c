    ...
    if (bits64)
    {
        switch (digest_s)
        {
            case 28:;
                ...
                maid_mem_copy(h, i512_224, sizeof(i512_224));
                break;
            case 32:;
                ...
                maid_mem_copy(h, i512_256, sizeof(i512_256));
                break;
            case 48:;
                ...
                maid_mem_copy(h, i384, sizeof(i384));
                break;
            case 64:;
                ...
                maid_mem_copy(h, i512, sizeof(i512));
                break;
        }
    }
    else
    {
        switch (digest_s)
        {
            case 28:;
                ...
                maid_mem_copy(h, i224, sizeof(i224));
                break;

            case 32:;
                u32 i256[8] = {0x6a09e667, 0xbb67ae85, 0x3c6ef372, 0xa54ff53a,
                               0x510e527f, 0x9b05688c, 0x1f83d9ab, 0x5be0cd19};
                maid_mem_copy(h, i256, sizeof(i256));
                break;
        }
    }
}
...
sha_update(void *ctx, const u8 *buffer, size_t size)
{
    if (ctx)
    {
        ...
        else
        {
            ...
            maid_mem_copy(buffer2, buffer, size);
            buffer2[size] = 0x80;
